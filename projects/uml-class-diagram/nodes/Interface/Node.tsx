...
function Interface({ state }: NodeProps<InterfaceState>) {
  return (
    <>
      ...
      <div className="uml-h-full uml-w-full uml-min-w-[220px] uml-cursor-pointer uml-overflow-hidden uml-rounded-lg uml-bg-white uml-font-medium uml-border-2 uml-border-yellow-400">
        <h1 className="uml-border-b-2 uml-border-yellow-400 uml-bg-yellow-200 uml-p-2 uml-text-center uml-text-base uml-font-semibold">
          <span>
            {"<<"}interface{">>"}
          </span>
          <br />
        ...
        <ul className="uml-min-h-[50px] uml-border-b-2 uml-border-yellow-400 uml-p-2 uml-transition-all">
